...
export const AdminCommissionConfigCard: React.FC<AdminCommissionConfigCardProps> = ({
  ...
  useEffect(() => {
    ...
    const tiersChanged =
      JSON.stringify(tiersInput.map((t: any) => ({ id: t.tierId, l1: t.level1Percent, l5: t.level5Percent }))) !==
      JSON.stringify(activeConfigTiers.map((t: any) => ({ id: t.tierId, l1: t.level1Percent, l5: t.level5Percent })));
